...
<!-- AFFICHAGE D'UN CADENAS POUR CLORE OU OUVRIR LE TOPIC (redaction de nouveaux messages) -->
      ...
      <?php if($posts)
            {
                ...
                {?>
                    <!-- AFFICAGE DU PSEUDO OU D'UN NOM POUR LE MESSAGE -->
                    <div class="message">
                        <div class="auteurDate">
                            <p class="auteurPost">
                    <?php if(!$post->getUser())
                    // Dans le cas ou le post possède un utilisateur NULL
                            {
                                echo "Utilisateur Anonyme";
                                // On anonymise le message
                            }
                            else
                            {
                                echo $post->getUser()->getNickName();
                                // Sinon on affiche son pseudo normalement
                            } ?>
                            </p>
