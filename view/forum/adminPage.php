...
{ ?>
    <div class="adminSection1">
            ...
            <!-- SECTION POUR AFFICHER LES MESSAGES SIGNALÉS -->
                 ...
                 <?php if($warns)
                        ...
                        <?php foreach($warns as $warn)
                                ...
                                <div class="warnedMessage">
                                    ...
                                    { ?>
                                        <a href="index.php?ctrl=admin&action=banUser&id=<?= $warn->getUser() ?>"><img class="interdit" src="./public/img/interdiction.png" alt="Icone d'interdiction"></a>
                                    <?php } ?>
            ...
            <!-- SECTION POUR AFFICHER LES UTILISATEURS BANNIS -->
                ...
                <div class="listBannedUsers">
                    ...
                    // Affiche de tous les utilisateurs qui ont été bannis
                        ...
                        <div class="bannedUsers">
                            ...
                            // Il y a en base de donnée, une colonne isBanned avec un booleen, 0 de base et 1 si l'utilisateur est banni, "getIsBanned()" récupère cette colonne et si sa valeur est de 1 (banni)
    ...
    <!-- SECTION POUR AFFICHER LA LISTE DE TOUS LES UTILISATEURS DU SITE -->
    <div class="adminSection1">
        <div>
                ...
                // On va récupérer ici tous les utilisateurs du site
                    { ?>
                      ...
                      // Si l'utilisateur n'est pas banni, on affiche un bouton qui va nous permettre de le ban et de l'empêcher de se connecter
                            { ?>
                                <a href="index.php?ctrl=admin&action=banUser&id=<?= $user->getId() ?>"><img class="interdit" src="./public/img/interdiction.png" alt="Icone d'interdiction"></a>
                      <?php }
                            else
                            { ?>
                                <p>(banned)</p>
